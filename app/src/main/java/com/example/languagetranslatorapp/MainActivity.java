...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages = {"From","English","Telugu","Kannada","Belarusian","Bulgarian","Bengali"
    ,"Catalan","Czech","Welsh","Hindi","Urdu"};

    String[] toLanguages = {"To","English","Telugu","Kannada","Belarusian","Bulgarian","Bengali"
            ,"Catalan","Czech","Welsh","Hindi","Urdu"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sourceEdt = findViewById(R.id.EdtSourceid);
        micTV = findViewById(R.id.micid);
        translateBtn = findViewById(R.id.traslatebtnid);
        translatedTV = findViewById(R.id.traslatetextid);
